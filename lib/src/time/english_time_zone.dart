class EnglishTimeZone {
  static final String DirectUtcRegex = r"\b(utc|gmt)(\s*[+\-\u00B1]?\s*[\d]{1,2}h?(\s*:\s*[\d]{1,2})?)?\b";

  static final List<String> AbbreviationsList = [
    "ABST",
    "ACDT",
    "ACST",
    "ACT",
  ...
  static final List<String> FullNameList = [
    "Acre Time",
  ...
  static final String BaseTimeZoneSuffixRegex = r"((\s+|-)(friendly|compatible))?(\s+|-)time(zone)?";

  static final String LocationTimeSuffixRegex =
      r"({BaseTimeZoneSuffixRegex})\b".replaceFirst("{BaseTimeZoneSuffixRegex}", BaseTimeZoneSuffixRegex);

  static final String TimeZoneEndRegex =
      r"({BaseTimeZoneSuffixRegex})$".replaceFirst("{BaseTimeZoneSuffixRegex}", BaseTimeZoneSuffixRegex);

  static final List<String> AmbiguousTimezoneList = [
    "bit",
    "get",
    "art",
    "cast",
  ...
  static const AbbrToMinMapping = <String, int>{
    "abst": 180,
    "acdt": 630,
    "acst": 570,
    "act": -10000,
  ...
  static const FullToMinMapping = <String, int>{
    "beijing": 480,
    "shanghai": 480,
    "shenzhen": 480,
    "suzhou": 480,
  ...
  static final List<String> MajorLocations = [
    "Dominican Republic",
    "Dominica",
    "Guinea Bissau",
    "Guinea-Bissau",
